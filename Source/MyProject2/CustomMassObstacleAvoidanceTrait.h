...
class MYPROJECT2_API UCustomMassObstacleAvoidanceTrait : public UMassEntityTraitBase
{
	GENERATED_BODY()
...
class MYPROJECT2_API UCustomMassNavigationObstacleTrait : public UMassEntityTraitBase
{
	GENERATED_BODY()
