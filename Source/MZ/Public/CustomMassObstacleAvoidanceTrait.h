...
USTRUCT()
struct MZ_API FCustomMassMovingAvoidanceParameters : public FMassConstSharedFragment
{
	GENERATED_BODY()
...
USTRUCT()
struct MZ_API FCustomMassStandingAvoidanceParameters : public FMassConstSharedFragment
{
	GENERATED_BODY()
...
class MZ_API UCustomMassObstacleAvoidanceTrait : public UMassEntityTraitBase
{
	GENERATED_BODY()
...
USTRUCT()
struct MZ_API FCustomMassNavigationObstacleGridCellLocationFragment : public FMassFragment
{
	GENERATED_BODY()
...
class MZ_API UCustomMassNavigationObstacleTrait : public UMassEntityTraitBase
{
	GENERATED_BODY()
