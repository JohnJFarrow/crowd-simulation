...
UCLASS()
class MZ_API UCustomMassNavigationSubsystem : public UWorldSubsystem
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class MZ_API UCustomAvoidanceProcessor : public UMassProcessor
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class MZ_API UCustomStandingAvoidanceProcessor : public UMassProcessor
{
	GENERATED_BODY()
