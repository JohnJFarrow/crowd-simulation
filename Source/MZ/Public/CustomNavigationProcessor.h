...
UCLASS()
class MZ_API UCustomMassNavigationObstacleGridProcessor : public UMassProcessor
{
	GENERATED_BODY()
...
UCLASS()
class MZ_API UCustomMassNavigationObstacleRemoverProcessor : public UMassObserverProcessor
{
	GENERATED_BODY()
